...
# Script that builds the OS/161 kernel from source.
# Usage: build-kernel.sh
#       [-h] -- help
#       [-c CONF ]
#       [-s SOURCE_DIR ]
#       [-i INSTALL_DIR ]
# This script is designed to be run when the system is initialized with Docker and has a clean state.

set -e

CONF="DUMBVM"
SOURCE_DIR="/home/os161/src"
INSTALL_DIR="/home/os161/root"
